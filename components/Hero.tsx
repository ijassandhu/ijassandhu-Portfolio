...
export default function Hero() {
  ...
  // Parallax: glow drifts up as user scrolls down
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="pointer-events-none absolute inset-0"
      >
        {/* Right: strong teal glow behind card */}
        <div
          className="absolute"
          style={{
            top: "10%",
        ...
        <div className="mx-auto w-full max-w-6xl px-5 sm:px-8">
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[minmax(0,1fr)_370px] lg:gap-12">
            ...
            >
              ...
              {/* Chips + location — one stagger child */}
              <motion.div
                variants={fadeUp}
            ...
            >
              ...
              >
                {/* Photo — full bleed, no white bottom section */}
                <div className="relative" style={{ height: "460px" }}>
                  ...
                  {/* Available badge — glass overlay top-right */}
                  <div
