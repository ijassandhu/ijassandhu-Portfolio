...
const focusCards = [
  {
    ...
    description:
      "LLM extraction from industrial PDFs into structured, validated outputs.",
  },
  {
    icon: <BrainCircuit size={18} />,
    title: "RAG Systems",
    description:
      "Semantic retrieval pipelines for focused, domain-aware question answering.",
  },
  {
    icon: <Workflow size={18} />,
    title: "AI Automation",
    description:
      "LLM workflows connected to APIs, tools, and practical business operations.",
  },
] as const;
...
function SelectedProjectCard({
  ...
  return (
    <article className="selected-card mobile-reveal relative mb-5 w-full transform-gpu overflow-hidden rounded-lg border border-[#e5e7eb] bg-white p-5 shadow-[0_16px_46px_rgba(17,24,39,0.10)] transition-[border-color,box-shadow] duration-200 hover:border-[#a9bec1] hover:shadow-[0_18px_52px_rgba(17,24,39,0.12)] lg:absolute lg:left-1/2 lg:top-1/2 lg:mb-0 lg:w-[520px] lg:p-7">
      ...
      <p className="mb-5 max-w-[35rem] text-sm leading-7 text-[#4b5563]">
        {project.description}
      </p>
      <ul className="mb-6 grid gap-2">
        {project.bullets.slice(0, 2).map((bullet) => (
          <li
            key={bullet}
            className="flex gap-3 text-[13px] leading-6 text-[#4b5563]"
          >
  ...
  return (
    <article className="story-card mobile-reveal rounded-lg border border-[#e5e7eb] bg-white p-6 shadow-[0_18px_55px_rgba(17,24,39,0.07)] lg:p-8">
      <div className="mb-6 flex items-center justify-between">
        <span className="text-xs font-black tracking-[0.22em] text-[#a9bec1]">
          {card.eyebrow}
        </span>
      ...
      <h3 className="mb-3 text-2xl font-black tracking-tight text-[#111827]">
        {card.title}
      </h3>
...
function ExperienceCard({
  ...
  return (
    <article
      className={`experience-item experience-item-${index} mobile-reveal relative flex gap-5`}
    >
    ...
    return (
      <div className="contact-reveal flex min-h-[320px] flex-col items-center justify-center rounded-lg border border-[#e5e7eb] bg-white p-8 text-center shadow-[0_18px_55px_rgba(17,24,39,0.07)]">
        ...
        <p className="max-w-sm text-sm leading-7 text-[#4b5563]">
          Thanks for reaching out. Your message has been saved and I will review
          it soon.
        </p>
        <button
  ...
  return (
    ...
    >
      <div className="grid gap-4 sm:grid-cols-2">
        <label
          className="grid gap-2 text-sm font-bold text-[#4b5563]"
      ...
      <label
        className="mt-4 grid gap-2 text-sm font-bold text-[#4b5563]"
...
export default function ScrollExperience() {
      ...
      const context = gsap.context(() => {
        ...
        media.add(
          ...
          () => {
            gsap
              ...
              .to(
                ".hero-copy",
                { yPercent: -16, autoAlpha: 0.62, ease: "none" },
                0
              )
              .to(
                ".hero-image-card",
                { yPercent: -8, scale: 0.92, autoAlpha: 0.7, ease: "none" },
                0
              )
              .to(
                ".hero-outline-word",
                { xPercent: -10, autoAlpha: 0.45, ease: "none" },
                0
              );

            const selectedCards =
              gsap.utils.toArray<HTMLElement>(".selected-card");
            ...
            const archiveCards =
              gsap.utils.toArray<HTMLElement>(".archive-card");
            ...
            archiveTimeline
              ...
              .to(
                archiveCards[2],
                { xPercent: 0, yPercent: -36, scale: 1.04, ease: "none" },
                0.58
              )
              .to(
                archiveCards[3],
                { xPercent: 54, yPercent: 12, scale: 1, ease: "none" },
                0.68
              )
            ...
            gsap.utils.toArray<HTMLElement>(".story-card").forEach((card) => {
              gsap
                ...
                .fromTo(
                  card,
                  { y: 54, scale: 0.92, autoAlpha: 0.36 },
                  { y: 0, scale: 1.04, autoAlpha: 1, ease: "none" }
                )
                .to(card, {
                  y: -28,
                  scale: 0.97,
        ...
        media.add(
          ...
          () => {
            ...
            gsap.utils
              .toArray<HTMLElement>(".mobile-reveal")
              .forEach((element) => {
                gsap.fromTo(
                  element,
                  { y: 28, autoAlpha: 0 },
  ...
  return (
    <div
      ref={rootRef}
      className="scroll-experience overflow-x-hidden bg-[#f7f8f8] text-[#111827]"
    >
      <section
        id="home"
        className="hero-scene relative min-h-screen overflow-hidden bg-[#f7f8f8] px-5 pt-14 sm:px-8 sm:pt-24"
      >
        <GridBackground />
        ...
        <div className="relative z-10 mx-auto grid min-h-[calc(100svh-4rem)] w-full max-w-6xl grid-cols-1 items-start gap-7 py-3 sm:min-h-[calc(100vh-6rem)] sm:items-center sm:gap-10 sm:py-12 lg:grid-cols-[minmax(0,1fr)_390px] lg:gap-16">
          <div className="hero-copy mobile-reveal max-w-2xl">
            ...
            <p className="mb-8 max-w-lg text-base leading-8 text-[#4b5563]">
            ...
            <div className="flex flex-wrap items-center gap-3 text-sm font-semibold text-[#4b5563]">
              ...
              <span>
                Open to AI engineering roles and applied AI collaborations
              </span>
            </div>
          </div>
              ...
              <div className="border-t border-[#e5e7eb] bg-white p-4">
                <div className="mb-3 flex items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="text-xs font-bold text-[#4f858b]">
                      AI Engineer
                    </p>
                  </div>
                </div>
      ...
      <section
        id="projects"
        className="selected-scene relative min-h-screen overflow-hidden bg-[#f7f8f8] px-5 py-20 sm:px-8 lg:h-screen lg:py-0"
      >
        <GridBackground />
        ...
        <div className="relative z-10 mx-auto flex min-h-full w-full max-w-6xl flex-col justify-center lg:h-screen">
          <div className="mobile-reveal max-w-xl">
            ...
            <p className="mt-5 max-w-lg text-base leading-8 text-[#4b5563]">
              Three practical AI systems, scrubbed through the viewport as the
              page moves.
            </p>
          </div>
      ...
      <section
        id="archive"
        className="dark-archive clip-dark relative min-h-screen overflow-hidden bg-[#090d10] px-5 py-20 text-white sm:px-8 lg:h-screen lg:py-0"
      >
        <GridBackground dark />
        <OutlineWord
          className="archive-bg-word right-[-0.16em] top-[10%] opacity-90"
          dark
        >
          Archive
        </OutlineWord>
        <div className="relative z-10 mx-auto flex min-h-full w-full max-w-6xl flex-col justify-center lg:h-screen">
          <div className="mobile-reveal max-w-xl">
            ...
            <p className="mt-5 max-w-lg text-base leading-8 text-white/62">
              A darker archive layer for the experiments, patterns, and
              implementation muscles behind the featured work.
            </p>
          </div>
      ...
      <section
        id="about"
        className="about-reveal clip-light relative overflow-hidden bg-[#f7f8f8] px-5 py-20 sm:px-8 lg:py-0"
      >
        <GridBackground />
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-6xl gap-10 lg:min-h-[250vh] lg:grid-cols-[320px_minmax(0,1fr)] lg:gap-16">
          <aside className="mobile-reveal lg:sticky lg:top-[84px] lg:flex lg:h-[calc(100vh-84px)] lg:items-center">
            <div className="w-full rounded-lg border border-[#e5e7eb] bg-white p-4 shadow-[0_18px_55px_rgba(17,24,39,0.08)]">
              ...
              <h2 className="mb-1 text-2xl font-black tracking-tight text-[#111827]">
                Jaskeerat Singh
              </h2>
              <p className="mb-5 text-sm font-bold text-[#4f858b]">
      ...
      <section
        id="experience"
        className="experience-skills relative overflow-hidden bg-white px-5 py-20 sm:px-8 sm:py-28"
      >
        <GridBackground />
      ...
      <section
        id="contact"
        className="contact-scene relative overflow-hidden bg-[#f7f8f8] px-5 py-20 sm:px-8 sm:py-28"
      >
        <GridBackground />
